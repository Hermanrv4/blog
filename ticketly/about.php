            ...
            <br>
                <div class="row">
            	    <div class="col-md-6 col-md-offset-3">
                        ...
                        <p>Hola, somos <strong><a target="_blank" href="http://gambetatv.com">Estudiantes de la UNTELS</a></strong> (Abizoft) creador de <a>ticketly</a>.</p>
                        ...
                        <br><br>
                        <p>Si quieres mejoras sobre este sistema no dudes en ponerte en contacto conmigo (hdesk@gmail.com).</p>
                        ...
                        <h1 style="text-align: center;"><a href="http://github.com/hdeskbitz" target="_blank">ABISOFT</a></h1>
                    </div>
                </div>
            </div>
        </div>
